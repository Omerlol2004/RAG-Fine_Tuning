@echo off
REM Setup script for RAG-Lite environment on Windows

echo Creating conda environment for RAG-Lite...
call conda create -n raglite python=3.10 -y

echo Activating raglite environment...
call conda activate raglite

echo Installing dependencies...
call pip install sentence-transformers==2.7.0 faiss-cpu==1.7.2 ^
